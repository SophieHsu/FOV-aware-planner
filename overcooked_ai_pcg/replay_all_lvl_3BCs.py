...
def play(elite_map, agent_configs, individuals, log_dir, load_data, agent_config_idx):
    """
    ...
    for elite in elite_map:
        ...
        log_file_name = str(curr_row_idx) + "_" + str(curr_col_idx) + "_" + str(curr_mat_idx)+"_" + str(agent_configs[agent_config_idx]['Agent1']['name'])
        ...
        #theApp = App(env, agent1, agent2, rand_seed=ind.rand_seed, player_idx=0, slow_time=False)
        #ind.fitness, ind.scores, ind.checkpoints, ind.player_workloads, ind.joint_actions, ind.concurr_active, ind.stuck_time = theApp.on_execute()
        ind.fitness, ind.scores, ind.checkpoints, ind.player_workloads, ind.joint_actions, ind.concurr_active, ind.stuck_time= run_overcooked_local(agent1, agent2, env, mdp, render=False)
...
if __name__ == "__main__":
    ...
    play(elite_map, agent_configs, individuals, log_dir, load_data, agent_config_idx)
